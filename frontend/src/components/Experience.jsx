...
const experiences = [
  {
    ...
    type: "current",
    responsibilities: [
      "Building AI-powered frontend applications with React, Next.js and TypeScript.",
      "Designing AI-integrated interfaces for complex workflows.",
      "Collaborating with engineering teams on scalable AI modules.",
  ...
  },
  {
    ...
    type: "past",
    responsibilities: [
      "Built MERN applications from scratch.",
      "Developed and documented REST APIs.",
      "Implemented JWT authentication and role-based access control.",
      "Optimized performance and loading speed across projects.",
    ],
